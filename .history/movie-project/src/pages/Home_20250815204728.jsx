...
const Home = () => {
  return (
    <div className='p-4 pt-16 bg-[#141414] '>
        ...
        <div className='pagination-container flex justify-between font-mono mt-5'>
          <button className='p-2  bg-[#1F1F1F] text-[#C5A236] rounded'>PREV</button>
          <button className='p-2  bg-[#1F1F1F] text-[#C5A236] rounded'>NEXT</button>
        </div>
