  ...
  return (
    <div className='p-4 pt-16 bg-[#141414]'>
      <input
        ...
        className='p-2 w-3/4 md:w-1/2 border rounded border-[#B8860B] bg-[#1F1F1F] bg-opacity-10 backdrop-blur-md text-[#B8860B] fixed left-1/4 z-10 top-16'
      ...
      <div className='pagination-container flex justify-between font-serif mt-5'>
        <button className='p-2 bg-[#E50914] hover:bg-red-600 hover:text-[#B8860B] text-[rgb(248,199,76)] rounded' onClick={()=>}>
          PREV
        </button>
        <button
