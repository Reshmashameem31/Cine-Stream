  ...
  return (
    <div className='p-4 pt-16 bg-[#141414] '>
        ...
        <div className='pagination-container flex justify-between font-serif mt-5'>
          <button className='p-2  bg-[#E50914] hover:bg-red-600  hover:text-[#B8860] text-[rgb(248,199,76)] rounded'>PREV</button>
          <button className='p-2  bg-[#E50914] text-[rgb(248,199,76)] rounded'>NEXT</button>
        </div>
