...
return (
    <div className='p-4 pt-16 bg-[#141414]'>
      <input
        ...
        className='p-2 w-3/4 left-1/2 md:w-1/2 border rounded border-[#B8860B] bg-[#1F1F1F] bg-opacity-10 backdrop-blur-md text-[rgb(248,199,76)] fixed md:left-1/4 z-10 top-16'
