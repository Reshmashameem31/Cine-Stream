...
import {FaHeart, FaRegHeart } from 'react-icons/fa'
  ...
  return (
    ...
    <div className=' bg-[#1F1F1F] p-4 rounded-lg font-serif  shadow-md  shadow-[#a4faffde] transition-transform duration-300 transform hover:scale-105 hover:z-10 hover:shadow-bg-amber md:hover:shadow-[rgb(248,199,76)]  relative opacity-100 group-hover:opacity-60 hover:!opacity-100 '>
