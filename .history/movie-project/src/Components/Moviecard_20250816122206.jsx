...
import {FaHeart, FaRegHeart } from 'react-icons/fa'
  ...
  return (
    <div className=' bg-[#1F1F1F] p-4 rounded-lg font-serif  shadow-md  shadow-[#3B82F6] transition-transform duration-300 transform hover:scale-110 z hover:shadow-[#05398b] text-white relative'>
