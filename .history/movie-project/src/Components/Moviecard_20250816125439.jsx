...
import {FaHeart, FaRegHeart } from 'react-icons/fa'
  ...
  return (
    ...
    <div className=' bg-[#1F1F1F] p-4 rounded-lg font-serif  shadow-md  shadow-[#3B82F6] transition-transform duration-300 transform hover:scale-105 hover:z-10 hover:shadow-[rgb(248,199,76)] text-white relative o hover:opacity-100 group-hover:opacity-60'>
